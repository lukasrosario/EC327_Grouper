...
//                        LocalDate groupFormDeadline = LocalDate.parse(groupFormDeadlineString, formatter);
                        ...
                        projectGroup projGroup = new projectGroup(course, teamName, projectName, LocalDate.parse(projectDeadlineString, formatter), description, Integer.parseInt(maxCapacity),firebaseAuth.getUid());
